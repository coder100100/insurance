...
Result<-compBagplot(u1B, type = "hdepth", sizesubset = 500,
...
u1B<-cbind(d1$X2041.2050,d2$X2041.2050[1:513])

depthContour(u1B, depth_params = list(method = "Mahalanobis"),xlim=c(-10,20),ylim=c(-3,16), points = TRUE, 
             legend = FALSE,levels=10, mcol = "blue")
...
plot(v1$alpha,v1$Volume/1e+6, type='l', lty=5,lwd=2,col='blue' , xlab="p", main="", ylim=c(0,350),ylab = expression(Volume ~S[n](p)))
...
####################################################################################
######################### 3 cities #############
plot(v1$alpha,v1$Volume/1e+3, type='l', lwd=2,col='black' , xlab="p", main="", ylim=c(0,500),ylab = expression(Volume ~S[n](p)))

lines(v2$alpha,v2$Volume/1e+3,type='o',pch = 6, lwd=2,cex = .8,  col='green')

lines(v3$alpha,v3$Volume/1e+3, type='o',pch = 0,lwd=2,cex = .8, col='blue') 
...
plot(v1$alpha,v1$Volume/1e+3, type='l', lwd=2,col='black' , xlab="p", main="", xlim=c(0,1), ylim=c(0,350),ylab = expression(Volume ~S[n](p)("1e+3")))
