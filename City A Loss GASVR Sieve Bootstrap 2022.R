...
#data:  residual
#Dickey-Fuller = -7.405, Lag order = 7, p-value = 0.01
...
plot(y11, type="n", ylim=range(0,UL),xlab="Year",
     ylab="Amount of loss (K)",  xaxt="n",first.panel=grid())
...
#write.csv(NCL_Pred,"./Insurance Cliam model/Models weekly data V_4/Deep Learning Tensorflow, Keras/Residual_bootstrap_A_NCL_predicted_Clim5.csv")
